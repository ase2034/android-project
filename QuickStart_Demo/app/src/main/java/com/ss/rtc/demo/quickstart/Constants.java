...
public class Constants {
    ...
    public static final String APPID = "6311fc2d69b4d6018aa678ff";

    //TOKEN 加入房间的时候需要使用token完成鉴权，详情参见{https://www.volcengine.com/docs/6348/70121}
    public static final String TOKEN = "0016311fc2d69b4d6018aa678ffQgBa9zEDUDkXY9BzIGMGADEyMzMyMQYAYWNlNjY2BgAAANBzIGMBANBzIGMCANBzIGMDANBzIGMEANBzIGMFANBzIGMgAOFyPA7RzmlaNGZc54ukArADTz8BaBmI0H67udX/d4je";
